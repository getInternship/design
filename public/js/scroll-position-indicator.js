...
$(window).load(function(){
  ...
  //
  //  CREATE THE INDICATORS AND ADD TO PAGE   // + '" data-loc="'
  ...
  $articles.each(function(i) {
    ...
    rawIndicators +=  '<a class="indicator indicator--upcoming" data-loc="'+  this.id +'" id="icon-'+  this.id +'" style="' + margins + '" href="#' +  this.id +'" ><span class="indicator-tooltip">' + $(this).find("h1").text() + '</span></a>';
  });
